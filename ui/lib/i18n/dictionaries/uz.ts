export const uz = {
  ...
  "admin.gameSettings": "O'yin sozlamalari",
  "admin.gameSettingsHint": "Bola o'ynaganda o'yin qanday ko'rinishini belgilaydi",
  "admin.itemsPerRound": "Bir o'yinda nechta savol",
  "admin.itemsPerRoundAll": "Barchasi",
  "admin.itemsPerRoundHint":
    "Bo'sh qoldirsangiz, barcha savollar beriladi (hozir {count} ta). Masalan 5 desangiz, har safar tasodifiy 5 tasi tanlanadi.",
  "admin.puzzleRows": "Qatorlar soni",
  "admin.puzzleCols": "Ustunlar soni",
  "admin.puzzlePiecesHint": "Rasm {rows} × {cols} = {count} ta bo'lakka bo'linadi",
  "admin.memoryPairs": "Kartochka juftliklari",
  "admin.memoryPairsHint": "{pairs} juft = {count} ta kartochka",
